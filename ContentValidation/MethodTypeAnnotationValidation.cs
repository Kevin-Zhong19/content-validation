...
public class MethodTypeAnnotationValidation : IValidation
{
    private IPlaywright _playwright;

    public MethodTypeAnnotationValidation(IPlaywright playwright)
    {
    ...
    public async Task<TResult> Validate(string testLink)
    {
        ...
        foreach (var tagName in tagNames)
        {
            ...
            res.ErrorInfo = "Missing Method Type Annotation: " + string.Join(",", allTags);
        }
